...
--
-- Host: mysql
-- Generation Time: Apr 15, 2025 at 03:26 PM
...
INSERT INTO `MenuItem` (MenuId, Title, Description, Price) VALUES
-- Menu 1: Italian Delights
(1, 'Truffle Risotto', 'Creamy rice infused with truffle oil, topped with shaved parmesan.', 18),
(1, 'Margherita Pizza', 'Classic pizza with fresh basil, mozzarella, and tomato sauce.', 12),
(1, 'Seafood Linguine', 'A mix of shrimp, clams, and calamari in a white wine sauce.', 20),
(1, 'Tiramisu', 'Italian dessert with layers of coffee-soaked ladyfingers and mascarpone cream.', 8),

-- Menu 2: Gourmet Fusion
(2, 'Kingfish', 'A refreshing blend of passion fruit, peanut, and Thai basil.', 20),
(2, 'Scallops', 'Delicately paired with celeriac, basmati, and fenugreek.', 19),
(2, 'Sea Bass', 'Served with poulpo, arrabiata, and guanciale for a rich taste.', 20),
(2, 'Perfect Egg', 'A luxurious combination of truffle, spätzle, and mushroom.', 8),

-- Menu 3: Fine Dining Experience
(3, '5-course menu', 'Begins with amuse-bouche, seafood starter, meat/fish main, cheese, and dessert.', 95),
(3, '6-course menu', 'Adds another gourmet course like elegant soup or sophisticated pasta.', 120),
(3, '7-course menu', 'Includes premium ingredient or seasonal specialty.', 134),
(3, '8-course menu', 'Ultimate indulgence with extra dessert or palate cleanser.', 154),

-- Menu 4: Dutch Classics
(4, 'King Crab with Lemon Beurre Blanc', 'Tender king crab legs served with a zesty lemon beurre blanc sauce.', 30),
(4, 'Dutch Asparagus Risotto', 'Creamy risotto with seasonal Dutch asparagus and Parmesan.', 22),
(4, 'Venison Medallions', 'Pan-seared with red wine reduction and vegetables.', 28),
(4, 'White Chocolate and Lavender Mousse', 'Light mousse infused with lavender and topped with white chocolate.', 10),

-- Menu 5: Modern Comfort
(5, 'Truffle Mac and Cheese', 'Macaroni in creamy truffle cheese sauce with breadcrumb topping.', 14),
(5, 'Spicy Tuna Tartare', 'Fresh tuna, avocado, sriracha mayo, and wonton chips.', 16),
(5, 'Slow-Cooked Lamb Shank', 'Braised lamb shank in red wine gravy with mashed potatoes.', 26),
(5, 'Salted Caramel Cheesecake', 'Cheesecake with salted caramel topping and graham crust.', 9),

-- Menu 6: Sea & Garden
(6, 'Dutch Apple Pie', 'Homemade and served warm with whipped cream.', 5),
(6, 'Classic Beef Croquettes', 'Crispy ragout croquettes served with mustard.', 8),
(6, 'Seafood Platter', 'Shrimp, mussels, calamari with aioli.', 25),
(6, 'Vegetarian Quiche', 'Savory quiche with seasonal vegetables and creamy filling.', 12),

-- Menu 7: French Elegance
(7, 'Foie Gras Terrine', 'Smooth foie gras with seasoning.', 15),
(7, 'Coq au Vin', 'Chicken stew with mushrooms, onions, and red wine sauce.', 22),
(7, 'Bouillabaisse', 'Fish stew with seafood, rouille, and bread.', 24),
(7, 'Crème Brûlée', 'Vanilla custard with caramelized sugar crust.', 8);
...
ALTER TABLE `HistoryTourSchedule`
  ADD PRIMARY KEY (`HistoryTourScheduleId`),
  ADD KEY `GuideId` (`GuideId`),
  ADD KEY `HistoryTourSchedule_ibfk_2` (`EventId`);
...
--
ALTER TABLE `Content`
  MODIFY `ContentId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `Event`
  MODIFY `EventId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
...
--
-- AUTO_INCREMENT for table `HistoryTourSchedule`
--
ALTER TABLE `HistoryTourSchedule`
  MODIFY `HistoryTourScheduleId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
ALTER TABLE `HistoryTourSchedule`
  ...
  ADD CONSTRAINT `HistoryTourSchedule_ibfk_2` FOREIGN KEY (`EventId`) REFERENCES `Event` (`EventId`);
