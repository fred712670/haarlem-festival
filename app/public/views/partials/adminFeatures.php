                ...
                <div class="col-lg-12">
                    <div class="admin-card">
                        <div class="admin-card-header">
                            <h5 class="admin-card-title">User Management</h5>
                        </div>
                                ...
                                <div class="table-responsive mt-4">
                                    <table class="table table-striped table-hover admin-table">
                                        <thead>
                                            <tr>
                                                <th>
                                                    <a href="<?= sortUrl('FullName', $viewData) ?>" class="text-decoration-none">
                                                        Name
                                                        <?= sortIcon('FullName', $viewData) ?>
                                                    </a>
                                                </th>
                                                <th>
                                                    <a href="<?= sortUrl('Email', $viewData) ?>" class="text-decoration-none">
                                                        Email
                                                        <?= sortIcon('Email', $viewData) ?>
                                                    </a>
                                                </th>
                                                <th>
                                                    <a href="<?= sortUrl('Role', $viewData) ?>" class="text-decoration-none">
                                                        Role
                                                        <?= sortIcon('Role', $viewData) ?>
                                                    </a>
                                                </th>
                                                <th>
                                                    <a href="<?= sortUrl('RegisteredDate', $viewData) ?>" class="text-decoration-none">
                                                        Registration Date
